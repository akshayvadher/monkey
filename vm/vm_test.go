...
func TestCallingFunctionsWithWrongArguments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(fmt.Sprintf("Test for input %q", tt.input), func(t *testing.T) {
			...
			err = vm.Run()
			if err == nil {
				t.Fatalf("expected VM error but resuled in non.")
			}
